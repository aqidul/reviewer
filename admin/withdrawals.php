...
<div class="admin-layout">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo ADMIN_URL; ?>/withdrawals.php" class="active">💸 Withdrawals <?php if($pending_count > 0): ?><span class="badge"><?php echo $pending_count; ?></span><?php endif; ?></a></li>
