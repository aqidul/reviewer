...
<div class="admin-layout">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo ADMIN_URL; ?>/task-pending.php">📋 Pending Tasks <?php if($pending_tasks_count > 0): ?><span class="badge"><?php echo $pending_tasks_count; ?></span><?php endif; ?></a></li>
            ...
            <div class="sidebar-divider"></div>
            <li><a href="<?php echo ADMIN_URL; ?>/reports.php" class="active">📈 Reports</a></li>
