...
<div class="admin-layout">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo ADMIN_URL; ?>/chatbot-unanswered.php">❓ Unanswered Q's <?php if($unanswered_count > 0): ?><span class="badge"><?php echo $unanswered_count; ?></span><?php endif; ?></a></li>
            <div class="sidebar-divider"></div>
