...
ALTER TABLE badges 
ADD COLUMN IF NOT EXISTS badge_code VARCHAR(50) UNIQUE AFTER name;
...
-- Update existing badges with badge_code based on their names
...
-- Insert/update default badges with proper badge_codes
...
-- Add index on badge_code for faster lookups
CREATE INDEX IF NOT EXISTS idx_badge_code ON badges(badge_code);
